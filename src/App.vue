...
<template>
  <div class="min-h-screen bg-gradient-to-br from-sky-50 via-blue-50 to-indigo-100 relative overflow-hidden" style="padding-top: 80px;">
    <!-- Background bubbles -->
    ...
    <!-- Download Toast -->
    <div v-if="showDownloadToast" class="fixed bottom-4 right-4 bg-green-500 text-white px-6 py-3 rounded-lg shadow-lg animate-slideInRight z-50">
